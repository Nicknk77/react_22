  ...
  return (
    <>
      ...
      <main style={{ width: 'fit-content', margin: '0 auto' }}>
        ...
        {!isAuth && <button style={{ padding: '5px', margin: '10px' }} onClick={() => nav('/signin')}>Sign In</button>}
        {!isAuth && <button style={{ padding: '5px', margin: '10px' }} onClick={() => nav('/signup')}>Sign Up</button>}
        <Outlet />
      </main>
    </>
  );
